...
const randomPhrases = [
    "Las mejores experiencias comienzan aquí.",
    "Entradas disponibles para cada ocasión.",
    "Reserva tu lugar con nosotros.",
    "Una entrada, miles de emociones.",
    "No te pierdas, entra y disfruta."
  ];
  

const EntradasScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity
          style={styles.button}
          onPress={() => navigation.navigate('FormularioEntradas')}
        >
          <Text style={styles.buttonText}>Registrar Entrada</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.button}
          onPress={() => navigation.navigate('ListaEntradas')}
        >
          <Text style={styles.buttonText}>Ver Entradas Vendidas</Text>
        </TouchableOpacity>
      </View>
